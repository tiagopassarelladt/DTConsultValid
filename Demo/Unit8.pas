...
begin
     ...
     ListaProdutos.Add('7894900039924' + '|' + '123' + '|' + 'FANTA LARANJA' );
     ListaProdutos.Add('7894900039927' + '|' + '111' + '|' + 'PRODUTO TESTE DE ERRO' );
     ...
     for I := 0 to Pred( DTConsultValid1.RetResumo.Count ) do
     begin
           msg.Lines.Add('TOTAL: '          + DTConsultValid1.RetResumo[I].TOTAL );
           msg.Lines.Add('CERTOS: '         + DTConsultValid1.RetResumo[I].CERTOS );
           msg.Lines.Add('AJUSTADO: '       + DTConsultValid1.RetResumo[I].AJUSTADO );
           msg.Lines.Add('ANALISECLIENTE: ' + DTConsultValid1.RetResumo[I].ANALISECLIENTE );
           msg.Lines.Add('ANALISECONSULT: ' + DTConsultValid1.RetResumo[I].ANALISECONSULT );
     end;
